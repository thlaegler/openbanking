...
------------- | ------------- | -------------
[**getStandingOrders**](StandingOrdersApi.md#getStandingOrders) | **GET** /standing-orders | Get Standing Orders


<a name="getStandingOrders"></a>
# **getStandingOrders**
> OBReadStandingOrder5 getStandingOrders(authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId)
