...
------------- | ------------- | -------------
[**getParty**](PartyApi.md#getParty) | **GET** /party | Get Parties


<a name="getParty"></a>
# **getParty**
> OBReadParty2 getParty(authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId)
...
```java
// Import classes:
//import com.laegler.openbanking.api.PartyApi;
...
try {
    ...
    System.err.println("Exception when calling PartyApi#getParty");
    e.printStackTrace();
}
```
