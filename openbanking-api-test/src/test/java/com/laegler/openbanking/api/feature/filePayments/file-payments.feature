...
Scenario: As an API-user I want to Create File Payments - Bad request
	Expecting HTTP status code: 400
	Given I'm an authorized API-user
	When I request to "POST" to "Create File Payments"
...
Scenario: As an API-user I want to Create File Payments - Unauthorized
...
Scenario: As an API-user I want to Create File Payments - Forbidden
...
Scenario: As an API-user I want to Create File Payments - Not found
...
Scenario: As an API-user I want to Create File Payments - Internal Server Error
...
Scenario: As an API-user I want to Create File Payments - Method Not Allowed
...
Scenario: As an API-user I want to Create File Payments - Not Acceptable
...
Scenario: As an API-user I want to Create File Payments - File Payments Created
...
Scenario: As an API-user I want to Create File Payments - Too Many Requests
...
Scenario: As an API-user I want to Get File Payments - Bad request
	Expecting HTTP status code: 400
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
	And the request body is ""
	Then the endpoint should answer with a response
	And the response code should be 400
...
Scenario: As an API-user I want to Get File Payments - Unauthorized
	Expecting HTTP status code: 401
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - Forbidden
	Expecting HTTP status code: 403
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - Not found
	Expecting HTTP status code: 404
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - Internal Server Error
	Expecting HTTP status code: 500
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - Method Not Allowed
	Expecting HTTP status code: 405
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - Not Acceptable
	Expecting HTTP status code: 406
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
...
Scenario: As an API-user I want to Get File Payments - File Payments Read
...
Scenario: As an API-user I want to Get File Payments - Too Many Requests
	Expecting HTTP status code: 429
	Given I'm an authorized API-user
	When I request to "GET" to "Get File Payments"
	Then the request content type is "application/json; charset&#x3D;utf-8"
