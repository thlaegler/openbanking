...
public class BalancesApiIntegrationTest extends AbstractIntegrationTest {
	...
	public void test_getBalances_400() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(400);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 401")
	public void test_getBalances_401() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(401);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 403")
	public void test_getBalances_403() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(403);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 404")
	public void test_getBalances_404() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(404);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 500")
	public void test_getBalances_500() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(500);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 405")
	public void test_getBalances_405() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(405);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 406")
	public void test_getBalances_406() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(406);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 200")
	public void test_getBalances_200() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(200);
	}

	@Test
	@Ignore("TODO: Define request to get HTTP status code 429")
	public void test_getBalances_429() {
		given().spec(spec).when().get("/balances/balances").then().assertThat().statusCode(429);
	}
