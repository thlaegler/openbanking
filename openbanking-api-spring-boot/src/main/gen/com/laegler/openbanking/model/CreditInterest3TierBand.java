...
public class CreditInterest3TierBand   {
  @JsonProperty("AER")
  ...
  public CreditInterest3TierBand AER(String AER) {
    this.AER = AER;
    return this;
  }
...
@Pattern(regexp="^(-?\\d{1,3}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest3TierBand applicationFrequency(ApplicationFrequencyEnum applicationFrequency) {
  ...
  **/
  ...
  public CreditInterest3TierBand bankInterestRate(String bankInterestRate) {
...
@Pattern(regexp="^(-?\\d{1,3}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest3TierBand bankInterestRateType(BankInterestRateTypeEnum bankInterestRateType) {
  ...
  **/
  ...
  public CreditInterest3TierBand calculationFrequency(CalculationFrequencyEnum calculationFrequency) {
  ...
  **/
  @ApiModelProperty(required = true, value = "How often is credit interest calculated for the account.")
  @NotNull
  ...
  public CreditInterest3TierBand depositInterestAppliedCoverage(DepositInterestAppliedCoverageEnum depositInterestAppliedCoverage) {
  ...
  **/
  ...
  public CreditInterest3TierBand fixedVariableInterestRateType(FixedVariableInterestRateTypeEnum fixedVariableInterestRateType) {
  ...
  **/
  ...
  public CreditInterest3TierBand identification(String identification) {
...
@Size(min=1,max=35) 
  ...
  public CreditInterest3TierBand notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public CreditInterest3TierBand addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public CreditInterest3TierBand otherApplicationFrequency(OtherApplicationFrequency otherApplicationFrequency) {
  ...
  **/
  ...
  public CreditInterest3TierBand otherBankInterestType(OtherBankInterestType otherBankInterestType) {
  ...
  **/
  ...
  public CreditInterest3TierBand otherCalculationFrequency(OtherCalculationFrequency otherCalculationFrequency) {
  ...
  **/
  ...
  public CreditInterest3TierBand tierValueMaximum(String tierValueMaximum) {
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest3TierBand tierValueMinimum(String tierValueMinimum) {
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditInterest3TierBand creditInterest3TierBand = (CreditInterest3TierBand) o;
    return Objects.equals(this.AER, creditInterest3TierBand.AER) &&
        Objects.equals(this.applicationFrequency, creditInterest3TierBand.applicationFrequency) &&
        Objects.equals(this.bankInterestRate, creditInterest3TierBand.bankInterestRate) &&
        Objects.equals(this.bankInterestRateType, creditInterest3TierBand.bankInterestRateType) &&
        Objects.equals(this.calculationFrequency, creditInterest3TierBand.calculationFrequency) &&
        Objects.equals(this.depositInterestAppliedCoverage, creditInterest3TierBand.depositInterestAppliedCoverage) &&
        Objects.equals(this.fixedVariableInterestRateType, creditInterest3TierBand.fixedVariableInterestRateType) &&
        Objects.equals(this.identification, creditInterest3TierBand.identification) &&
        Objects.equals(this.notes, creditInterest3TierBand.notes) &&
        Objects.equals(this.otherApplicationFrequency, creditInterest3TierBand.otherApplicationFrequency) &&
        Objects.equals(this.otherBankInterestType, creditInterest3TierBand.otherBankInterestType) &&
        Objects.equals(this.otherCalculationFrequency, creditInterest3TierBand.otherCalculationFrequency) &&
        Objects.equals(this.tierValueMaximum, creditInterest3TierBand.tierValueMaximum) &&
        Objects.equals(this.tierValueMinimum, creditInterest3TierBand.tierValueMinimum);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditInterest3TierBand {\n");
