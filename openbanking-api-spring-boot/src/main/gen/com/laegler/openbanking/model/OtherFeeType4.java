...
public class OtherFeeType4   {
  ...
  public OtherFeeType4 code(String code) {
    this.code = code;
    return this;
  }
...
@Pattern(regexp="^\\w{0,4}$") @Size(min=0,max=4) 
  ...
  public OtherFeeType4 description(String description) {
...
@Size(min=1,max=350) 
  ...
  public OtherFeeType4 feeCategory(FeeCategoryEnum feeCategory) {
  ...
  **/
  ...
  public OtherFeeType4 name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OtherFeeType4 otherFeeType4 = (OtherFeeType4) o;
    return Objects.equals(this.code, otherFeeType4.code) &&
        Objects.equals(this.description, otherFeeType4.description) &&
        Objects.equals(this.feeCategory, otherFeeType4.feeCategory) &&
        Objects.equals(this.name, otherFeeType4.name);
  }
