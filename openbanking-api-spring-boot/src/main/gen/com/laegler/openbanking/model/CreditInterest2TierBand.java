...
public class CreditInterest2TierBand   {
  @JsonProperty("AER")
  ...
  public CreditInterest2TierBand AER(String AER) {
    this.AER = AER;
    return this;
  }
...
@Pattern(regexp="^(-?\\d{1,3}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest2TierBand applicationFrequency(ApplicationFrequencyEnum applicationFrequency) {
  ...
  **/
  ...
  public CreditInterest2TierBand bankInterestRate(String bankInterestRate) {
...
@Pattern(regexp="^(-?\\d{1,3}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest2TierBand bankInterestRateType(BankInterestRateTypeEnum bankInterestRateType) {
  ...
  **/
  ...
  public CreditInterest2TierBand calculationFrequency(CalculationFrequencyEnum calculationFrequency) {
  ...
  **/
  ...
  public CreditInterest2TierBand depositInterestAppliedCoverage(DepositInterestAppliedCoverageEnum depositInterestAppliedCoverage) {
  ...
  **/
  ...
  public CreditInterest2TierBand fixedVariableInterestRateType(FixedVariableInterestRateTypeEnum fixedVariableInterestRateType) {
  ...
  **/
  ...
  public CreditInterest2TierBand identification(String identification) {
...
@Size(min=1,max=35) 
  ...
  public CreditInterest2TierBand notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public CreditInterest2TierBand addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public CreditInterest2TierBand otherApplicationFrequency(OtherApplicationFrequency1 otherApplicationFrequency) {
  ...
  **/
  ...
  public CreditInterest2TierBand otherBankInterestType(OtherBankInterestType otherBankInterestType) {
  ...
  **/
  ...
  public CreditInterest2TierBand otherCalculationFrequency(OtherCalculationFrequency1 otherCalculationFrequency) {
  ...
  **/
  ...
  public CreditInterest2TierBand tierValueMaximum(String tierValueMaximum) {
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public CreditInterest2TierBand tierValueMinimum(String tierValueMinimum) {
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditInterest2TierBand creditInterest2TierBand = (CreditInterest2TierBand) o;
    return Objects.equals(this.AER, creditInterest2TierBand.AER) &&
        Objects.equals(this.applicationFrequency, creditInterest2TierBand.applicationFrequency) &&
        Objects.equals(this.bankInterestRate, creditInterest2TierBand.bankInterestRate) &&
        Objects.equals(this.bankInterestRateType, creditInterest2TierBand.bankInterestRateType) &&
        Objects.equals(this.calculationFrequency, creditInterest2TierBand.calculationFrequency) &&
        Objects.equals(this.depositInterestAppliedCoverage, creditInterest2TierBand.depositInterestAppliedCoverage) &&
        Objects.equals(this.fixedVariableInterestRateType, creditInterest2TierBand.fixedVariableInterestRateType) &&
        Objects.equals(this.identification, creditInterest2TierBand.identification) &&
        Objects.equals(this.notes, creditInterest2TierBand.notes) &&
        Objects.equals(this.otherApplicationFrequency, creditInterest2TierBand.otherApplicationFrequency) &&
        Objects.equals(this.otherBankInterestType, creditInterest2TierBand.otherBankInterestType) &&
        Objects.equals(this.otherCalculationFrequency, creditInterest2TierBand.otherCalculationFrequency) &&
        Objects.equals(this.tierValueMaximum, creditInterest2TierBand.tierValueMaximum) &&
        Objects.equals(this.tierValueMinimum, creditInterest2TierBand.tierValueMinimum);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditInterest2TierBand {\n");
