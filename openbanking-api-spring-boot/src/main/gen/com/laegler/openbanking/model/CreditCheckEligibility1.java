 ...
 */
@ApiModel(description = "Credit check criteria that the account holder will need to meet to take out the CCC product")
@Validated
@javax.annotation.Generated(value = "class com.laegler.openbanking.codegen.module.OpenbankingSpringCodegen", date = "2019-10-19T13:25:17.080+13:00")

public class CreditCheckEligibility1   {
  @JsonProperty("Notes")
  @Valid
  ...
  public CreditCheckEligibility1 notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public CreditCheckEligibility1 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public CreditCheckEligibility1 scoringType(ScoringTypeEnum scoringType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditCheckEligibility1 creditCheckEligibility1 = (CreditCheckEligibility1) o;
    return Objects.equals(this.notes, creditCheckEligibility1.notes) &&
        Objects.equals(this.scoringType, creditCheckEligibility1.scoringType);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditCheckEligibility1 {\n");
