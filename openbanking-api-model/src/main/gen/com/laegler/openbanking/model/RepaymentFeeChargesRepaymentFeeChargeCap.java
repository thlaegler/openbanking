...
public class RepaymentFeeChargesRepaymentFeeChargeCap   {
  /**
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap feeCapAmount(String feeCapAmount) {
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap feeType(List<FeeTypeEnum> feeType) {
    this.feeType = feeType;
    return this;
  }

  public RepaymentFeeChargesRepaymentFeeChargeCap addFeeTypeItem(FeeTypeEnum feeTypeItem) {
...
@Size(min=1) 
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public RepaymentFeeChargesRepaymentFeeChargeCap addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public RepaymentFeeChargesRepaymentFeeChargeCap otherFeeType(List<BranchCurrentAccountResponseOtherFeeType> otherFeeType) {
    this.otherFeeType = otherFeeType;
    return this;
  }

  public RepaymentFeeChargesRepaymentFeeChargeCap addOtherFeeTypeItem(BranchCurrentAccountResponseOtherFeeType otherFeeTypeItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepaymentFeeChargesRepaymentFeeChargeCap repaymentFeeChargesRepaymentFeeChargeCap = (RepaymentFeeChargesRepaymentFeeChargeCap) o;
    return Objects.equals(this.cappingPeriod, repaymentFeeChargesRepaymentFeeChargeCap.cappingPeriod) &&
        Objects.equals(this.feeCapAmount, repaymentFeeChargesRepaymentFeeChargeCap.feeCapAmount) &&
        Objects.equals(this.feeCapOccurrence, repaymentFeeChargesRepaymentFeeChargeCap.feeCapOccurrence) &&
        Objects.equals(this.feeType, repaymentFeeChargesRepaymentFeeChargeCap.feeType) &&
        Objects.equals(this.minMaxType, repaymentFeeChargesRepaymentFeeChargeCap.minMaxType) &&
        Objects.equals(this.notes, repaymentFeeChargesRepaymentFeeChargeCap.notes) &&
        Objects.equals(this.otherFeeType, repaymentFeeChargesRepaymentFeeChargeCap.otherFeeType);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepaymentFeeChargesRepaymentFeeChargeCap {\n");
