...
public class FeaturesAndBenefits3FeatureBenefitEligibility   {
  @JsonProperty("Amount")
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility description(String description) {
...
@Size(min=1,max=500) 
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility indicator(Boolean indicator) {
  ...
  **/
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=350) 
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public FeaturesAndBenefits3FeatureBenefitEligibility addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility otherType(OtherType otherType) {
  ...
  **/
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility period(PeriodEnum period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility textual(String textual) {
...
@Size(min=1,max=500) 
  ...
  public FeaturesAndBenefits3FeatureBenefitEligibility type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FeaturesAndBenefits3FeatureBenefitEligibility featuresAndBenefits3FeatureBenefitEligibility = (FeaturesAndBenefits3FeatureBenefitEligibility) o;
    return Objects.equals(this.amount, featuresAndBenefits3FeatureBenefitEligibility.amount) &&
        Objects.equals(this.description, featuresAndBenefits3FeatureBenefitEligibility.description) &&
        Objects.equals(this.indicator, featuresAndBenefits3FeatureBenefitEligibility.indicator) &&
        Objects.equals(this.name, featuresAndBenefits3FeatureBenefitEligibility.name) &&
        Objects.equals(this.notes, featuresAndBenefits3FeatureBenefitEligibility.notes) &&
        Objects.equals(this.otherType, featuresAndBenefits3FeatureBenefitEligibility.otherType) &&
        Objects.equals(this.period, featuresAndBenefits3FeatureBenefitEligibility.period) &&
        Objects.equals(this.textual, featuresAndBenefits3FeatureBenefitEligibility.textual) &&
        Objects.equals(this.type, featuresAndBenefits3FeatureBenefitEligibility.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeaturesAndBenefits3FeatureBenefitEligibility {\n");
