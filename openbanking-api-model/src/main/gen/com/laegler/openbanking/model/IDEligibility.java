 ...
 */
@ApiModel(description = "Identity verification criteria that the account holder will need to meet to take out the BCA product")
@Validated
...
public class IDEligibility   {
  ...
  public IDEligibility notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public IDEligibility addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public IDEligibility URL(String URL) {
    this.URL = URL;
    return this;
  }
...
@Size(min=1,max=500) 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IDEligibility idEligibility = (IDEligibility) o;
    return Objects.equals(this.notes, idEligibility.notes) &&
        Objects.equals(this.URL, idEligibility.URL);
  }
