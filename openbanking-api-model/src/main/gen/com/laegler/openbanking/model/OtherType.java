...
public class OtherType   {
  ...
  public OtherType code(String code) {
    this.code = code;
    return this;
  }
...
@Pattern(regexp="^\\w{0,4}$") @Size(min=0,max=4) 
  ...
  public OtherType description(String description) {
...
@Size(min=1,max=350) 
  ...
  public OtherType name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, otherType.code) &&
        Objects.equals(this.description, otherType.description) &&
