 ...
 */
public enum OpenbankingCucumberProperties {
  INSTANCE;
  ...
  OpenbankingCucumberProperties() {
    this.reportPath = "output" + File.separator + "Run_" + System.currentTimeMillis()
   ...
   * 
   * @return true if all tests to be added to single klov build and false if one build per thread
   *         will be created
   */
  ...
  /**
   * Sets the mongoDB username. No need to set username if mongoDB is not running in --auth mode
   * 
