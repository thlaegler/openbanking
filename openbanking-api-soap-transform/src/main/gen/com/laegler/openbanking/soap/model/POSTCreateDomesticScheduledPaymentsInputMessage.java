 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBWriteDomesticScheduled2Param" type="{http://laegler.com/openbanking/soap/model}OBWriteDomesticScheduled2"/&gt;
...
@XmlRootElement(name = "POST_CreateDomesticScheduledPayments_InputMessage")
public class POSTCreateDomesticScheduledPaymentsInputMessage {

    @XmlElement(name = "OBWriteDomesticScheduled2Param", required = true)
    protected OBWriteDomesticScheduled2 obWriteDomesticScheduled2Param;
    ...
    /**
     * Gets the value of the obWriteDomesticScheduled2Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBWriteDomesticScheduled2 }
     *     
     */
    public OBWriteDomesticScheduled2 getOBWriteDomesticScheduled2Param() {
        return obWriteDomesticScheduled2Param;
    }

    /**
     * Sets the value of the obWriteDomesticScheduled2Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBWriteDomesticScheduled2 }
     *     
     */
    public void setOBWriteDomesticScheduled2Param(OBWriteDomesticScheduled2 value) {
        this.obWriteDomesticScheduled2Param = value;
    }
