...
/**
 * <p>Java class for CalculationFrequency5.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CalculationFrequency5"&gt;
 ...
 * 
 */
@XmlType(name = "CalculationFrequency5")
@XmlEnum
public enum CalculationFrequency5 {
    ...
    CalculationFrequency5(String v) {
        value = v;
    }
    ...
    public static CalculationFrequency5 fromValue(String v) {
        for (CalculationFrequency5 c: CalculationFrequency5 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
