...
/**
 * <p>Java class for ApplicationFrequency1.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ApplicationFrequency1"&gt;
 ...
 * 
 */
@XmlType(name = "ApplicationFrequency1")
@XmlEnum
public enum ApplicationFrequency1 {
    ...
    ApplicationFrequency1(String v) {
        value = v;
    }
    ...
    public static ApplicationFrequency1 fromValue(String v) {
        for (ApplicationFrequency1 c: ApplicationFrequency1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
