...
@XmlRootElement(name = "GET_GetInternationalStandingOrderConsentsConsentId_InputMessage")
public class GETGetInternationalStandingOrderConsentsConsentIdInputMessage {
