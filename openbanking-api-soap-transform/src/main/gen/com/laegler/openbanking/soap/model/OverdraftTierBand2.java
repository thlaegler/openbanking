 ...
 * 
 * <p>Java class for OverdraftTierBand2 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OverdraftTierBand2"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="AgreementPeriod" type="{http://laegler.com/openbanking/soap/model}AgreementPeriod2" minOccurs="0"/&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="OverdraftFeesCharges" type="{http://laegler.com/openbanking/soap/model}OverdraftFeesCharge5" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="OverdraftInterestChargingCoverage" type="{http://laegler.com/openbanking/soap/model}OverdraftInterestChargingCoverage2" minOccurs="0"/&gt;
...
@XmlType(name = "OverdraftTierBand2", propOrder = {
    "agreementLengthMax",
    "agreementLengthMin",
    "agreementPeriod",
...
public class OverdraftTierBand2 {

    @XmlElement(name = "AgreementLengthMax")
    protected BigInteger agreementLengthMax;
    @XmlElement(name = "AgreementLengthMin")
    protected BigInteger agreementLengthMin;
    @XmlElement(name = "AgreementPeriod")
    @XmlSchemaType(name = "string")
    protected AgreementPeriod2 agreementPeriod;
    ...
    protected List<OverdraftFeesCharge5> overdraftFeesCharges;
    @XmlElement(name = "OverdraftInterestChargingCoverage")
    @XmlSchemaType(name = "string")
    protected OverdraftInterestChargingCoverage2 overdraftInterestChargingCoverage;
     ...
     *     
     */
    public BigInteger getAgreementLengthMax() {
     ...
     *     
     */
    public void setAgreementLengthMax(BigInteger value) {
     ...
     *     
     */
    public BigInteger getAgreementLengthMin() {
     ...
     *     
     */
    public void setAgreementLengthMin(BigInteger value) {
     ...
     * @return
     *     possible object is
     *     {@link AgreementPeriod2 }
     *     
     */
    public AgreementPeriod2 getAgreementPeriod() {
     ...
     *     
     */
    public void setAgreementPeriod(AgreementPeriod2 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftFeesCharge5 }
     * 
     * 
     */
    public List<OverdraftFeesCharge5> getOverdraftFeesCharges() {
        if (overdraftFeesCharges == null) {
            overdraftFeesCharges = new ArrayList<OverdraftFeesCharge5>();
        }
     ...
     * @return
     *     possible object is
     *     {@link OverdraftInterestChargingCoverage2 }
     *     
     */
    public OverdraftInterestChargingCoverage2 getOverdraftInterestChargingCoverage() {
     ...
     *     
     */
    public void setOverdraftInterestChargingCoverage(OverdraftInterestChargingCoverage2 value) {
