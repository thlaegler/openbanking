...
/**
 * <p>Java class for CalculationFrequency13.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CalculationFrequency13"&gt;
 ...
 * 
 */
@XmlType(name = "CalculationFrequency13")
@XmlEnum
public enum CalculationFrequency13 {
    ...
    CalculationFrequency13(String v) {
        value = v;
    }
    ...
    public static CalculationFrequency13 fromValue(String v) {
        for (CalculationFrequency13 c: CalculationFrequency13 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
