 ...
 * 
 * <p>Java class for NonRepaymentFeeChargeCap complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NonRepaymentFeeChargeCap"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FeeType" type="{http://laegler.com/openbanking/soap/model}FeeType10" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "NonRepaymentFeeChargeCap", propOrder = {
    "cappingPeriod",
    "feeCapAmount",
    "feeCapOccurrence",
    "feeType",
...
public class NonRepaymentFeeChargeCap {
    ...
    @XmlSchemaType(name = "string")
    protected List<FeeType10> feeType;
     ...
     * 
     */
    public List<FeeType10> getFeeType() {
        if (feeType == null) {
            feeType = new ArrayList<FeeType10>();
        }
        return this.feeType;
    }
