...
/**
 * <p>Java class for SearchforoneormoreresourcesusingHTTPPOSTResponse1 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SearchforoneormoreresourcesusingHTTPPOSTResponse1"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Resources" type="{http://laegler.com/openbanking/soap/model}OBAuthorities" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SearchforoneormoreresourcesusingHTTPPOSTResponse1", propOrder = {
    "resources",
    "itemsPerPage",
    "schemas",
    "startIndex",
...
public class SearchforoneormoreresourcesusingHTTPPOSTResponse1 {

    @XmlElement(name = "Resources")
    protected List<OBAuthorities> resources;
    ...
    public List<OBAuthorities> getResources() {
        if (resources == null) {
            resources = new ArrayList<OBAuthorities>();
        }
