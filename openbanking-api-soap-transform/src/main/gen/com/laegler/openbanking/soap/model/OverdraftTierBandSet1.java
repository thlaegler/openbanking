 ...
 * 
 * <p>Java class for OverdraftTierBandSet1 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OverdraftTierBandSet1"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="OverdraftFeesCharges" type="{http://laegler.com/openbanking/soap/model}OverdraftFeesCharge2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="OverdraftTierBand" type="{http://laegler.com/openbanking/soap/model}OverdraftTierBand1" maxOccurs="unbounded"/&gt;
 *         &lt;element name="OverdraftType" type="{http://laegler.com/openbanking/soap/model}OverdraftType1" minOccurs="0"/&gt;
...
@XmlType(name = "OverdraftTierBandSet1", propOrder = {
    "authorisedIndicator",
    "bufferAmount",
    "identification",
    "notes",
...
public class OverdraftTierBandSet1 {
    ...
    protected List<OverdraftFeesCharge2> overdraftFeesCharges;
    @XmlElement(name = "OverdraftTierBand", required = true)
    protected List<OverdraftTierBand1> overdraftTierBand;
    @XmlElement(name = "OverdraftType")
    @XmlSchemaType(name = "string")
    protected OverdraftType1 overdraftType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftFeesCharge2 }
     * 
     * 
     */
    public List<OverdraftFeesCharge2> getOverdraftFeesCharges() {
        if (overdraftFeesCharges == null) {
            overdraftFeesCharges = new ArrayList<OverdraftFeesCharge2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftTierBand1 }
     * 
     * 
     */
    public List<OverdraftTierBand1> getOverdraftTierBand() {
        if (overdraftTierBand == null) {
            overdraftTierBand = new ArrayList<OverdraftTierBand1>();
        }
     ...
     *     
     */
    public void setOverdraftType(OverdraftType1 value) {
