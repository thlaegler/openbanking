 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBEventPolling1Param" type="{http://laegler.com/openbanking/soap/model}OBEventPolling1"/&gt;
...
@XmlRootElement(name = "POST_CreateEvents_InputMessage")
public class POSTCreateEventsInputMessage {

    @XmlElement(name = "OBEventPolling1Param", required = true)
    protected OBEventPolling1 obEventPolling1Param;
    ...
    /**
     * Gets the value of the obEventPolling1Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBEventPolling1 }
     *     
     */
    public OBEventPolling1 getOBEventPolling1Param() {
        return obEventPolling1Param;
    }

    /**
     * Sets the value of the obEventPolling1Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBEventPolling1 }
     *     
     */
    public void setOBEventPolling1Param(OBEventPolling1 value) {
        this.obEventPolling1Param = value;
    }
