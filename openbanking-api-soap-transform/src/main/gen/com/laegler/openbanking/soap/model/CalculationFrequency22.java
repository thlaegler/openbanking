...
/**
 * <p>Java class for CalculationFrequency22.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CalculationFrequency22"&gt;
 ...
 * 
 */
@XmlType(name = "CalculationFrequency22")
@XmlEnum
public enum CalculationFrequency22 {
    ...
    CalculationFrequency22(String v) {
        value = v;
    }
    ...
    public static CalculationFrequency22 fromValue(String v) {
        for (CalculationFrequency22 c: CalculationFrequency22 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
