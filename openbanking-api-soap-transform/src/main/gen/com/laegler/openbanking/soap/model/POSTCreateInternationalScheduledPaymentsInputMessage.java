 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBWriteInternationalScheduled2Param" type="{http://laegler.com/openbanking/soap/model}OBWriteInternationalScheduled2"/&gt;
...
@XmlRootElement(name = "POST_CreateInternationalScheduledPayments_InputMessage")
public class POSTCreateInternationalScheduledPaymentsInputMessage {

    @XmlElement(name = "OBWriteInternationalScheduled2Param", required = true)
    protected OBWriteInternationalScheduled2 obWriteInternationalScheduled2Param;
    ...
    /**
     * Gets the value of the obWriteInternationalScheduled2Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBWriteInternationalScheduled2 }
     *     
     */
    public OBWriteInternationalScheduled2 getOBWriteInternationalScheduled2Param() {
        return obWriteInternationalScheduled2Param;
    }

    /**
     * Sets the value of the obWriteInternationalScheduled2Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBWriteInternationalScheduled2 }
     *     
     */
    public void setOBWriteInternationalScheduled2Param(OBWriteInternationalScheduled2 value) {
        this.obWriteInternationalScheduled2Param = value;
    }
