 ...
 * Borrowing details
 * 
 * <p>Java class for Overdraft complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Overdraft"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="OverdraftTierBandSet" type="{http://laegler.com/openbanking/soap/model}OverdraftTierBandSet" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "Overdraft", propOrder = {
    "notes",
...
public class Overdraft {
    ...
    protected List<OverdraftTierBandSet> overdraftTierBandSet;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftTierBandSet }
     * 
     * 
     */
    public List<OverdraftTierBandSet> getOverdraftTierBandSet() {
        if (overdraftTierBandSet == null) {
            overdraftTierBandSet = new ArrayList<OverdraftTierBandSet>();
        }
