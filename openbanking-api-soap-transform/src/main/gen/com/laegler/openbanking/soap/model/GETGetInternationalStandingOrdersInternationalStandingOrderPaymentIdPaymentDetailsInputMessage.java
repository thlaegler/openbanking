 ...
 *       &lt;sequence&gt;
 *         &lt;element name="InternationalStandingOrderPaymentId" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlRootElement(name = "GET_GetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetails_InputMessage")
public class GETGetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetailsInputMessage {

    @XmlElement(name = "InternationalStandingOrderPaymentId", required = true)
    protected String internationalStandingOrderPaymentId;
    ...
    /**
     * Gets the value of the internationalStandingOrderPaymentId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getInternationalStandingOrderPaymentId() {
        return internationalStandingOrderPaymentId;
    }

    /**
     * Sets the value of the internationalStandingOrderPaymentId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInternationalStandingOrderPaymentId(String value) {
        this.internationalStandingOrderPaymentId = value;
    }
