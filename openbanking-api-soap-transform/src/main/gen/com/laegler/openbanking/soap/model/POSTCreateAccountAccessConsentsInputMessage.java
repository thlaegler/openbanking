 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBReadConsent1Param" type="{http://laegler.com/openbanking/soap/model}OBReadConsent1"/&gt;
...
@XmlRootElement(name = "POST_CreateAccountAccessConsents_InputMessage")
public class POSTCreateAccountAccessConsentsInputMessage {

    @XmlElement(name = "OBReadConsent1Param", required = true)
    protected OBReadConsent1 obReadConsent1Param;
    ...
    /**
     * Gets the value of the obReadConsent1Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBReadConsent1 }
     *     
     */
    public OBReadConsent1 getOBReadConsent1Param() {
        return obReadConsent1Param;
    }

    /**
     * Sets the value of the obReadConsent1Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBReadConsent1 }
     *     
     */
    public void setOBReadConsent1Param(OBReadConsent1 value) {
        this.obReadConsent1Param = value;
    }
