...
/**
 * <p>Java class for ApplicationFrequency2.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ApplicationFrequency2"&gt;
 ...
 * 
 */
@XmlType(name = "ApplicationFrequency2")
@XmlEnum
public enum ApplicationFrequency2 {
    ...
    ApplicationFrequency2(String v) {
        value = v;
    }
    ...
    public static ApplicationFrequency2 fromValue(String v) {
        for (ApplicationFrequency2 c: ApplicationFrequency2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
