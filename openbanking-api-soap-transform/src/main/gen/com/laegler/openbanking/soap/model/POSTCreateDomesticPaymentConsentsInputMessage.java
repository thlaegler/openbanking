 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBWriteDomesticConsent3Param" type="{http://laegler.com/openbanking/soap/model}OBWriteDomesticConsent3"/&gt;
...
@XmlRootElement(name = "POST_CreateDomesticPaymentConsents_InputMessage")
public class POSTCreateDomesticPaymentConsentsInputMessage {

    @XmlElement(name = "OBWriteDomesticConsent3Param", required = true)
    protected OBWriteDomesticConsent3 obWriteDomesticConsent3Param;
    ...
    /**
     * Gets the value of the obWriteDomesticConsent3Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBWriteDomesticConsent3 }
     *     
     */
    public OBWriteDomesticConsent3 getOBWriteDomesticConsent3Param() {
        return obWriteDomesticConsent3Param;
    }

    /**
     * Sets the value of the obWriteDomesticConsent3Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBWriteDomesticConsent3 }
     *     
     */
    public void setOBWriteDomesticConsent3Param(OBWriteDomesticConsent3 value) {
        this.obWriteDomesticConsent3Param = value;
    }
