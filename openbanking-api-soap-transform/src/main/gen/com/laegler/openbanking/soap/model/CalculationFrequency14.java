...
/**
 * <p>Java class for CalculationFrequency14.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CalculationFrequency14"&gt;
 ...
 * 
 */
@XmlType(name = "CalculationFrequency14")
@XmlEnum
public enum CalculationFrequency14 {
    ...
    CalculationFrequency14(String v) {
        value = v;
    }
    ...
    public static CalculationFrequency14 fromValue(String v) {
        for (CalculationFrequency14 c: CalculationFrequency14 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
