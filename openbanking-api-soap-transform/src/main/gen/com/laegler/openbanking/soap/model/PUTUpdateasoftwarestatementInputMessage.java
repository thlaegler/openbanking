 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="SoftwareStatementState" type="{http://laegler.com/openbanking/soap/model}SoftwareStatementStateSchema"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PUT_Updateasoftwarestatement_InputMessage")
public class PUTUpdateasoftwarestatementInputMessage {
    ...
    @XmlElement(name = "SoftwareStatementState", required = true)
    protected SoftwareStatementStateSchema softwareStatementState;
    ...
    /**
     * Gets the value of the softwareStatementState property.
     * 
     * @return
     *     possible object is
     *     {@link SoftwareStatementStateSchema }
     *     
     */
    public SoftwareStatementStateSchema getSoftwareStatementState() {
        return softwareStatementState;
    }

    /**
     * Sets the value of the softwareStatementState property.
     * 
     * @param value
     *     allowed object is
     *     {@link SoftwareStatementStateSchema }
     *     
     */
    public void setSoftwareStatementState(SoftwareStatementStateSchema value) {
        this.softwareStatementState = value;
    }
