...
@XmlRootElement(name = "DELETE_DeleteEventSubscriptionsEventSubscriptionId_InputMessage")
public class DELETEDeleteEventSubscriptionsEventSubscriptionIdInputMessage {
