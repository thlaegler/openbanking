 ...
 * 
 * <p>Java class for FeeChargeCap2 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FeeChargeCap2"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FeeType" type="{http://laegler.com/openbanking/soap/model}FeeType12" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "FeeChargeCap2", propOrder = {
    "cappingPeriod",
    "feeCapAmount",
    "feeCapOccurrence",
    "feeType",
...
public class FeeChargeCap2 {
    ...
    @XmlSchemaType(name = "string")
    protected List<FeeType12> feeType;
     ...
     * 
     */
    public List<FeeType12> getFeeType() {
        if (feeType == null) {
            feeType = new ArrayList<FeeType12>();
        }
        return this.feeType;
    }
