 ...
 * 
 * <p>Java class for OverdraftFeeChargeCap8 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OverdraftFeeChargeCap8"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FeeType" type="{http://laegler.com/openbanking/soap/model}FeeType25" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "OverdraftFeeChargeCap8", propOrder = {
    "cappingPeriod",
    "feeCapAmount",
    "feeCapOccurrence",
    "feeType",
...
public class OverdraftFeeChargeCap8 {
    ...
    @XmlSchemaType(name = "string")
    protected List<FeeType25> feeType;
     ...
     * 
     */
    public List<FeeType25> getFeeType() {
        if (feeType == null) {
            feeType = new ArrayList<FeeType25>();
        }
        return this.feeType;
    }
