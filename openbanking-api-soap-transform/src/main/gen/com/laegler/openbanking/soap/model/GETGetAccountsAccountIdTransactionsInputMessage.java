 ...
 *         &lt;element name="fromBookingDateTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/&gt;
 *         &lt;element name="toBookingDateTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GET_GetAccountsAccountIdTransactions_InputMessage")
public class GETGetAccountsAccountIdTransactionsInputMessage {
    ...
    protected XMLGregorianCalendar fromBookingDateTime;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar toBookingDateTime;
    ...
    /**
     * Gets the value of the fromBookingDateTime property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public XMLGregorianCalendar getFromBookingDateTime() {
        return fromBookingDateTime;
    }

    /**
     * Sets the value of the fromBookingDateTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setFromBookingDateTime(XMLGregorianCalendar value) {
        this.fromBookingDateTime = value;
    }

    /**
     * Gets the value of the toBookingDateTime property.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getToBookingDateTime() {
        return toBookingDateTime;
    }

    /**
     * Sets the value of the toBookingDateTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setToBookingDateTime(XMLGregorianCalendar value) {
        this.toBookingDateTime = value;
    }
