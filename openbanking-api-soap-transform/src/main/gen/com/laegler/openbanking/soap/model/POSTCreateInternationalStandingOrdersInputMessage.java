 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OBWriteInternationalStandingOrder3Param" type="{http://laegler.com/openbanking/soap/model}OBWriteInternationalStandingOrder3"/&gt;
...
@XmlRootElement(name = "POST_CreateInternationalStandingOrders_InputMessage")
public class POSTCreateInternationalStandingOrdersInputMessage {

    @XmlElement(name = "OBWriteInternationalStandingOrder3Param", required = true)
    protected OBWriteInternationalStandingOrder3 obWriteInternationalStandingOrder3Param;
    ...
    /**
     * Gets the value of the obWriteInternationalStandingOrder3Param property.
     * 
     * @return
     *     possible object is
     *     {@link OBWriteInternationalStandingOrder3 }
     *     
     */
    public OBWriteInternationalStandingOrder3 getOBWriteInternationalStandingOrder3Param() {
        return obWriteInternationalStandingOrder3Param;
    }

    /**
     * Sets the value of the obWriteInternationalStandingOrder3Param property.
     * 
     * @param value
     *     allowed object is
     *     {@link OBWriteInternationalStandingOrder3 }
     *     
     */
    public void setOBWriteInternationalStandingOrder3Param(OBWriteInternationalStandingOrder3 value) {
        this.obWriteInternationalStandingOrder3Param = value;
    }
