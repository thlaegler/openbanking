 ...
 * 
 * <p>Java class for FeeChargeCap1 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FeeChargeCap1"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="FeeType" type="{http://laegler.com/openbanking/soap/model}FeeType8" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "FeeChargeCap1", propOrder = {
    "cappingPeriod",
    "feeCapAmount",
    "feeCapOccurrence",
    "feeType",
...
public class FeeChargeCap1 {
    ...
    @XmlSchemaType(name = "string")
    protected List<FeeType8> feeType;
     ...
     * 
     */
    public List<FeeType8> getFeeType() {
        if (feeType == null) {
            feeType = new ArrayList<FeeType8>();
        }
        return this.feeType;
    }
