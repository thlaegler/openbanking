...
/**
 * <p>Java class for CalculationFrequency2.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CalculationFrequency2"&gt;
 ...
 * 
 */
@XmlType(name = "CalculationFrequency2")
@XmlEnum
public enum CalculationFrequency2 {
    ...
    CalculationFrequency2(String v) {
        value = v;
    }
    ...
    public static CalculationFrequency2 fromValue(String v) {
        for (CalculationFrequency2 c: CalculationFrequency2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
