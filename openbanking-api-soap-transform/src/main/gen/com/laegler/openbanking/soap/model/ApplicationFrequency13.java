 ...
 * <p>
 * <pre>
 * &lt;simpleType name="ApplicationFrequency13"&gt;
 ...
 * 
 */
@XmlType(name = "ApplicationFrequency13")
@XmlEnum
public enum ApplicationFrequency13 {
    ...
    ApplicationFrequency13(String v) {
        value = v;
    }
    ...
    public static ApplicationFrequency13 fromValue(String v) {
        for (ApplicationFrequency13 c: ApplicationFrequency13 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
