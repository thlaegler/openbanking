...
/**
 * <p>Java class for ApplicationFrequency22.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ApplicationFrequency22"&gt;
 ...
 * 
 */
@XmlType(name = "ApplicationFrequency22")
@XmlEnum
public enum ApplicationFrequency22 {
    ...
    ApplicationFrequency22(String v) {
        value = v;
    }
    ...
    public static ApplicationFrequency22 fromValue(String v) {
        for (ApplicationFrequency22 c: ApplicationFrequency22 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
