 ...
 * 
 * <p>Java class for OverdraftTierBandSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OverdraftTierBandSet"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="OverdraftFeesCharges" type="{http://laegler.com/openbanking/soap/model}OverdraftFeesCharge" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="OverdraftTierBand" type="{http://laegler.com/openbanking/soap/model}OverdraftTierBand" maxOccurs="unbounded"/&gt;
 *         &lt;element name="OverdraftType" type="{http://laegler.com/openbanking/soap/model}OverdraftType" minOccurs="0"/&gt;
 *         &lt;element name="TierBandMethod" type="{http://laegler.com/openbanking/soap/model}TierBandMethod1"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "OverdraftTierBandSet", propOrder = {
    "authorisedIndicator",
    "bufferAmount",
    "identification",
...
public class OverdraftTierBandSet {
    ...
    protected List<OverdraftFeesCharge> overdraftFeesCharges;
    @XmlElement(name = "OverdraftTierBand", required = true)
    protected List<OverdraftTierBand> overdraftTierBand;
    @XmlElement(name = "OverdraftType")
    @XmlSchemaType(name = "string")
    protected OverdraftType overdraftType;
    @XmlElement(name = "TierBandMethod", required = true)
    @XmlSchemaType(name = "string")
    protected TierBandMethod1 tierBandMethod;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftFeesCharge }
     * 
     * 
     */
    public List<OverdraftFeesCharge> getOverdraftFeesCharges() {
        if (overdraftFeesCharges == null) {
            overdraftFeesCharges = new ArrayList<OverdraftFeesCharge>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OverdraftTierBand }
     * 
     * 
     */
    public List<OverdraftTierBand> getOverdraftTierBand() {
        if (overdraftTierBand == null) {
            overdraftTierBand = new ArrayList<OverdraftTierBand>();
        }
     ...
     *     
     */
    public void setOverdraftType(OverdraftType value) {
     ...
     *     
     */
    public void setTierBandMethod(TierBandMethod1 value) {
