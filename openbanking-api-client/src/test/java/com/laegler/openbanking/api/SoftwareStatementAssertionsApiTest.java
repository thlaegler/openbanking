 ...
 *
 * API tests for SoftwareStatementAssertionsApi 
 */
public class SoftwareStatementAssertionsApiTest {


    private SoftwareStatementAssertionsApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", SoftwareStatementAssertionsApi.class, providers);
     ...
     */
    @Test
    public void organisationOrganisationTypeOrganisationIdSoftwareStatementSoftwareStatementIdSoftwareStatementAssertionGetTest() {
        String organisationType = null;
        String organisationId = null;
        String softwareStatementId = null;
        //api.organisationOrganisationTypeOrganisationIdSoftwareStatementSoftwareStatementIdSoftwareStatementAssertionGet(organisationType, organisationId, softwareStatementId);
