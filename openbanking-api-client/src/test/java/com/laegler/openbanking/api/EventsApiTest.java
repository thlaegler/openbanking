...
public class EventsApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", EventsApi.class, providers);
    ...
    public void createEventsTest() {
        OBEventPolling1 obEventPolling1Param = null;
        String authorization = null;
        String xFapiAuthDate = null;
        String xFapiCustomerIpAddress = null;
        String xFapiInteractionId = null;
        //OBEventPollingResponse1 response = api.createEvents(obEventPolling1Param, authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId);
