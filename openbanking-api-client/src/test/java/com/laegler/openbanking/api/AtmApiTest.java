...
public class AtmApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", AtmApi.class, providers);
     ...
     */
    @Test
    public void atmsGetTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //ATMResponse response = api.atmsGet(ifModifiedSince, ifNoneMatch);
     ...
     */
    @Test
    public void atmsHeadTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //Object response = api.atmsHead(ifModifiedSince, ifNoneMatch);
        //assertNotNull(response);
        // TODO: test validations
