...
public class BeneficiariesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", BeneficiariesApi.class, providers);
     ...
     */
    @Test
    public void getAccountsAccountIdBeneficiariesTest() {
        String accountId = null;
        String authorization = null;
        String xFapiAuthDate = null;
        String xFapiCustomerIpAddress = null;
        String xFapiInteractionId = null;
        //OBReadBeneficiary3 response = api.getAccountsAccountIdBeneficiaries(accountId, authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId);
    ...
    public void getBeneficiariesTest() {
        ...
        String xFapiCustomerIpAddress = null;
        String xFapiInteractionId = null;
        //OBReadBeneficiary3 response = api.getBeneficiaries(authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId);
        //assertNotNull(response);
        // TODO: test validations
