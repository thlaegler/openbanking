...
@XmlEnumValue("AnyBusinessCustomer") ANYBUSINESSCUSTOMER(String.valueOf("AnyBusinessCustomer")), @XmlEnumValue("BusinessCurrentAccount") BUSINESSCURRENTACCOUNT(String.valueOf("BusinessCurrentAccount")), @XmlEnumValue("CreditScoring") CREDITSCORING(String.valueOf("CreditScoring")), @XmlEnumValue("OtherFinancialHolding") OTHERFINANCIALHOLDING(String.valueOf("OtherFinancialHolding")), @XmlEnumValue("Other") OTHER(String.valueOf("Other")), @XmlEnumValue("MinimumTurnover") MINIMUMTURNOVER(String.valueOf("MinimumTurnover"));
