...
@XmlEnumValue("Director") DIRECTOR(String.valueOf("Director")), @XmlEnumValue("Owner") OWNER(String.valueOf("Owner")), @XmlEnumValue("Other") OTHER(String.valueOf("Other")), @XmlEnumValue("Partner") PARTNER(String.valueOf("Partner")), @XmlEnumValue("SignificantControl") SIGNIFICANTCONTROL(String.valueOf("SignificantControl"));
