...
public interface InternationalPaymentsApi  {
    ...
    @ApiOperation(value = "Create International Payment Consents", tags={  })
    @ApiResponses(value = { 
    ...
    public OBWriteInternationalConsentResponse3 createInternationalPaymentConsents(OBWriteInternationalConsent3 obWriteInternationalConsent3Param, @HeaderParam("Authorization") String authorization, @HeaderParam("x-idempotency-key") String xIdempotencyKey, @HeaderParam("x-jws-signature") String xJwsSignature, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Create International Payments", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "Too Many Requests"),
        @ApiResponse(code = 500, message = "Internal Server Error", response = OBErrorResponse1.class) })
    public OBWriteInternationalResponse3 createInternationalPayments(OBWriteInternational2 obWriteInternational2Param, @HeaderParam("Authorization") String authorization, @HeaderParam("x-idempotency-key") String xIdempotencyKey, @HeaderParam("x-jws-signature") String xJwsSignature, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Get International Payment Consents", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Get International Payments", tags={  })
    @ApiResponses(value = { 
