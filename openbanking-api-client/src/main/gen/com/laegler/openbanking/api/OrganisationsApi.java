...
public interface OrganisationsApi  {
    ...
    @ApiOperation(value = "Get all organisations that the client is authorised to retrieve", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Get the given organisation's details", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Enrol a eIDAS QWAC/QSealC-bearing participant", tags={  })
    @ApiResponses(value = { 
    ...
    public void organisationOrganisationTypePost(@PathParam("OrganisationType") String organisationType, @PathParam("OrganisationTypeForQSealCOnboarding") String organisationTypeForQSealCOnboarding, EnrolSchema enrol);
}
