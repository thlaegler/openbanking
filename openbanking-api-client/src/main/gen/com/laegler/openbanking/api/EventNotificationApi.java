...
public interface EventNotificationApi  {
    ...
    @ApiOperation(value = "Send an event notification", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 202, message = "Accepted") })
    public void createEventNotification(String obEventNotification1Param, @HeaderParam("x-fapi-financial-id") String xFapiFinancialId, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
}
