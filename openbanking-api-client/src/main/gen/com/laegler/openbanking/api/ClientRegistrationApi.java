...
public interface ClientRegistrationApi  {
    ...
    @ApiOperation(value = "Delete a client by way of Client ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Get a client by way of Client ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Update a client by way of Client ID", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Client registration", response = InlineResponse201.class),
        @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class) })
    public InlineResponse201 registerClientIdPut(@PathParam("ClientId") String clientId, @HeaderParam("Authorization") String authorization, String requestBody);
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Register a client by way of a Software Statement Assertion", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Client registration", response = InlineResponse201.class),
        @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class) })
    public InlineResponse201 registerPost(String requestBody);
}
