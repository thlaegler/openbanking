 ...
 */
@ApiModel(description = "Other eligibility which is not covered by the main eligibility of the CCC product")
@Validated
@javax.annotation.Generated(value = "class com.laegler.openbanking.codegen.module.OpenbankingSpringCodegen", date = "2019-10-19T13:25:29.752+13:00")

public class Eligibility1OtherEligibility   {
  @JsonProperty("Amount")
  ...
  public Eligibility1OtherEligibility amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^(-?\\d{1,14}){1}(\\.\\d{1,4}){0,1}$") 
  ...
  public Eligibility1OtherEligibility description(String description) {
...
@Size(min=1,max=500) 
  ...
  public Eligibility1OtherEligibility indicator(Boolean indicator) {
  ...
  **/
  ...
  public Eligibility1OtherEligibility name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=350) 
  ...
  public Eligibility1OtherEligibility notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public Eligibility1OtherEligibility addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public Eligibility1OtherEligibility otherType(OtherType otherType) {
  ...
  **/
  ...
  public Eligibility1OtherEligibility period(PeriodEnum period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public Eligibility1OtherEligibility textual(String textual) {
...
@Size(min=1,max=500) 
  ...
  public Eligibility1OtherEligibility type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Eligibility1OtherEligibility eligibility1OtherEligibility = (Eligibility1OtherEligibility) o;
    return Objects.equals(this.amount, eligibility1OtherEligibility.amount) &&
        Objects.equals(this.description, eligibility1OtherEligibility.description) &&
        Objects.equals(this.indicator, eligibility1OtherEligibility.indicator) &&
        Objects.equals(this.name, eligibility1OtherEligibility.name) &&
        Objects.equals(this.notes, eligibility1OtherEligibility.notes) &&
        Objects.equals(this.otherType, eligibility1OtherEligibility.otherType) &&
        Objects.equals(this.period, eligibility1OtherEligibility.period) &&
        Objects.equals(this.textual, eligibility1OtherEligibility.textual) &&
        Objects.equals(this.type, eligibility1OtherEligibility.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class Eligibility1OtherEligibility {\n");
