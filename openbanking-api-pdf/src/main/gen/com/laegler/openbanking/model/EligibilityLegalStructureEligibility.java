 ...
 */
@ApiModel(description = "Legal structure eligibility requirement to access the BCA product.")
@Validated
@javax.annotation.Generated(value = "class com.laegler.openbanking.codegen.module.OpenbankingSpringCodegen", date = "2019-10-19T13:25:29.752+13:00")

public class EligibilityLegalStructureEligibility   {
  /**
   * Defines the legal structure of the business to access the BCA product.
   */
  ...
  public EligibilityLegalStructureEligibility legalStructure(LegalStructureEnum legalStructure) {
  ...
  **/
  @ApiModelProperty(value = "Defines the legal structure of the business to access the BCA product.")
  ...
  public EligibilityLegalStructureEligibility notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public EligibilityLegalStructureEligibility addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public EligibilityLegalStructureEligibility otherLegalStructure(OtherLegalStructure otherLegalStructure) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EligibilityLegalStructureEligibility eligibilityLegalStructureEligibility = (EligibilityLegalStructureEligibility) o;
    return Objects.equals(this.legalStructure, eligibilityLegalStructureEligibility.legalStructure) &&
        Objects.equals(this.notes, eligibilityLegalStructureEligibility.notes) &&
        Objects.equals(this.otherLegalStructure, eligibilityLegalStructureEligibility.otherLegalStructure);
  }
  ...
  public String toString() {
    ...
    sb.append("class EligibilityLegalStructureEligibility {\n");
