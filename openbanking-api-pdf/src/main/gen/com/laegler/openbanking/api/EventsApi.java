...
public interface EventsApi {
    ...
    @ApiOperation(value = "Create Events", nickname = "createEvents", notes = "", response = OBEventPollingResponse1.class, authorizations = {
