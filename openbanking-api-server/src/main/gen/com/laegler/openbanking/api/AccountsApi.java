...
public interface AccountsApi  {
    ...
    @ApiOperation(value = "Get Accounts", tags={ "Accounts",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Accounts Read", response = OBReadAccount4.class),
    ...
    public OBReadAccount4 getAccounts(@HeaderParam("Authorization") String authorization, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
