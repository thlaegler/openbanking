...
public interface CccApi  {
    ...
    @ApiOperation(value = "", tags={ "CCC",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with a list of `Commercial Credit Card` data", response = CommercialCreditCardResponse.class),
    ...
    public CommercialCreditCardResponse commercialCreditCardsGet(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
    ...
    public Object commercialCreditCardsHead(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
}
