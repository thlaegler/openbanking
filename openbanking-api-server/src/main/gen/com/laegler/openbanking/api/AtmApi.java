...
public interface AtmApi  {
    ...
    @ApiOperation(value = "", tags={ "ATM",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with a list of `ATM` data", response = ATMResponse.class),
    ...
    public ATMResponse atmsGet(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
    ...
    public Object atmsHead(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
}
