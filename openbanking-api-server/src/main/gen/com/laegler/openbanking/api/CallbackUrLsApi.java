...
public interface CallbackUrLsApi  {
    ...
    @ApiOperation(value = "Delete a callback URI", tags={ "Callback URLs",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Amend a callback URI", tags={ "Callback URLs",  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "Too Many Requests"),
        @ApiResponse(code = 500, message = "Internal Server Error", response = OBErrorResponse1.class) })
    public OBCallbackUrlResponse1 callbackUrlsCallbackUrlIdPut(@PathParam("CallbackUrlId") String callbackUrlId, @Valid OBCallbackUrl1 obCallbackUrl1Param, @HeaderParam("Authorization") String authorization, @HeaderParam("x-jws-signature") String xJwsSignature, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Read all callback URLs", tags={ "Callback URLs",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json; charset=utf-8", "application/jose+jwe", "application/jose", "application/scim+json" })
    @Produces({ "application/prs.openbanking.opendata.v2.3+json", "application/json; charset=utf-8", "application/jose+jwe", "application/json", "application/scim+json" })
    @ApiOperation(value = "Create a callback URL", tags={ "Callback URLs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "Too Many Requests"),
        @ApiResponse(code = 500, message = "Internal Server Error", response = OBErrorResponse1.class) })
    public OBCallbackUrlResponse1 callbackUrlsPost(@Valid OBCallbackUrl1 obCallbackUrl1Param, @HeaderParam("Authorization") String authorization, @HeaderParam("x-jws-signature") String xJwsSignature, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
}
