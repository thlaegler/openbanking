...
public interface BeneficiariesApi  {
    ...
    @ApiOperation(value = "Get Beneficiaries", tags={ "Beneficiaries",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Beneficiaries Read", response = OBReadBeneficiary3.class),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "Too Many Requests"),
        @ApiResponse(code = 500, message = "Internal Server Error", response = OBErrorResponse1.class) })
    public OBReadBeneficiary3 getBeneficiaries(@HeaderParam("Authorization") String authorization, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
}
