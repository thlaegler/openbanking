...
public interface CertificateAssociationsApi  {
    ...
    @ApiOperation(value = "Associate/de-associate a QSEAL/OBSEAL certificate with the given software statement", tags={ "Certificate Associations" })
    @ApiResponses(value = { 
    ...
    public void organisationOrganisationTypeOrganisationIdSoftwareStatementSoftwareStatementIdCertificateOrganisationAssociativeCertificateTypeCertificateOrKeyIdPut(@PathParam("OrganisationType") String organisationType, @PathParam("OrganisationId") String organisationId, @PathParam("SoftwareStatementId") @Size(max=22) String softwareStatementId, @PathParam("OrganisationAssociativeCertificateType") String organisationAssociativeCertificateType, @PathParam("CertificateOrKeyId") @Size(max=256) String certificateOrKeyId, @Valid CertificateOrKeyAssociationSchema certificateOrKeyAssociation);
}
