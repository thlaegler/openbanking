...
public interface ScheduledPaymentsApi  {
    ...
    @ApiOperation(value = "Get Scheduled Payments", tags={ "Scheduled Payments",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Scheduled Payments Read", response = OBReadScheduledPayment2.class),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 429, message = "Too Many Requests"),
        @ApiResponse(code = 500, message = "Internal Server Error", response = OBErrorResponse1.class) })
    public OBReadScheduledPayment2 getScheduledPayments(@HeaderParam("Authorization") String authorization, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
}
