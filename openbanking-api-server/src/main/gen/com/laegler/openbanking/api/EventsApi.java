...
public interface EventsApi  {
    ...
    @ApiOperation(value = "Create Events", tags={ "Events" })
    @ApiResponses(value = { 
    ...
    public OBEventPollingResponse1 createEvents(@Valid OBEventPolling1 obEventPolling1Param, @HeaderParam("Authorization") String authorization, @HeaderParam("x-fapi-auth-date") String xFapiAuthDate, @HeaderParam("x-fapi-customer-ip-address") String xFapiCustomerIpAddress, @HeaderParam("x-fapi-interaction-id") String xFapiInteractionId);
}
