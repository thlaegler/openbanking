...
public interface SoftwareStatementRedirectUrIsApi  {
    ...
    @ApiOperation(value = "Add a redirect URI to the given Software Statement", tags={ "Software Statement Redirect URIs" })
    @ApiResponses(value = { 
    ...
    public void organisationOrganisationTypeOrganisationIdSoftwareStatementSoftwareStatementIdRedirectUriPost(@PathParam("OrganisationType") String organisationType, @PathParam("OrganisationId") String organisationId, @PathParam("SoftwareStatementId") @Size(max=22) String softwareStatementId, @Valid SoftwareStatementRedirectURISchema softwareStatementRedirectURI);
}
