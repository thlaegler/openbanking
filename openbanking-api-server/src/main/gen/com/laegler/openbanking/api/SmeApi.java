...
public interface SmeApi  {
    ...
    @ApiOperation(value = "", tags={ "SME",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with a list of `Unsecured SME Lending` data", response = UnsecuredSMELendingResponse.class),
    ...
    public UnsecuredSMELendingResponse unsecuredSmeLoansGet(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
    ...
    public Object unsecuredSmeLoansHead(@HeaderParam("If-Modified-Since") String ifModifiedSince, @HeaderParam("If-None-Match") String ifNoneMatch);
}
