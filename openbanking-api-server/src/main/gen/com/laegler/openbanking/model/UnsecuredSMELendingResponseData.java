...
public class UnsecuredSMELendingResponseData  {
  ...
  **/
  private List<UnsecuredSMELendingResponseBrand> brand = new ArrayList<UnsecuredSMELendingResponseBrand>();
 /**
   * Brand registered by the banking group at https://register.fca.org.uk/
   * @return brand
  **/
  @JsonProperty("Brand")
  @NotNull
 @Size(min=1)  public List<UnsecuredSMELendingResponseBrand> getBrand() {
    return brand;
  }
