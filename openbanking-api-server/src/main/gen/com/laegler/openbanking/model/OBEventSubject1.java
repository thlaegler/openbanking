...
public class OBEventSubject1  {
  ...
  **/
  ...
  @NotNull
 @Size(min=1,max=128)  public String getHttpopenbankingOrgUkrid() {
    return httpopenbankingOrgUkrid;
  }
  ...
  **/
  ...
  @NotNull
 @Size(min=1)  public List<OBEventLink1> getHttpopenbankingOrgUkrlk() {
    return httpopenbankingOrgUkrlk;
  }
  ...
  **/
  ...
  @NotNull
 @Size(min=1,max=128)  public String getHttpopenbankingOrgUkrty() {
    return httpopenbankingOrgUkrty;
  }
  ...
  **/
  ...
  @NotNull
 @Size(min=1,max=128)  public String getSubjectType() {
    return subjectType;
  }
