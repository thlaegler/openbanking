...
@XmlEnumValue("BusinessOnly") BUSINESSONLY(String.valueOf("BusinessOnly")), @XmlEnumValue("CreditScoring") CREDITSCORING(String.valueOf("CreditScoring")), @XmlEnumValue("ExistingCustomers") EXISTINGCUSTOMERS(String.valueOf("ExistingCustomers")), @XmlEnumValue("IdAndV") IDANDV(String.valueOf("IdAndV")), @XmlEnumValue("Mortgage") MORTGAGE(String.valueOf("Mortgage")), @XmlEnumValue("NoArrearsOnLoan") NOARREARSONLOAN(String.valueOf("NoArrearsOnLoan")), @XmlEnumValue("NoCustomerInArrears") NOCUSTOMERINARREARS(String.valueOf("NoCustomerInArrears")), @XmlEnumValue("NewCustomersOnly") NEWCUSTOMERSONLY(String.valueOf("NewCustomersOnly")), @XmlEnumValue("Other") OTHER(String.valueOf("Other")), @XmlEnumValue("StartUp") STARTUP(String.valueOf("StartUp")), @XmlEnumValue("Turnover") TURNOVER(String.valueOf("Turnover"));
