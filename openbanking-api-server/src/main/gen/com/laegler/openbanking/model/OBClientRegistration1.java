...
@XmlEnumValue("private_key_jwt") PRIVATE_KEY_JWT(String.valueOf("private_key_jwt")), @XmlEnumValue("client_secret_jwt") CLIENT_SECRET_JWT(String.valueOf("client_secret_jwt")), @XmlEnumValue("client_secret_basic") CLIENT_SECRET_BASIC(String.valueOf("client_secret_basic")), @XmlEnumValue("client_secret_post") CLIENT_SECRET_POST(String.valueOf("client_secret_post")), @XmlEnumValue("tls_client_auth") TLS_CLIENT_AUTH(String.valueOf("tls_client_auth"));
 ...
 @Size(min=1,max=36)  public String getClientId() {
    return clientId;
  }
 ...
 @Min(0)  public Integer getClientIdIssuedAt() {
    return clientIdIssuedAt;
  }
 ...
 @Size(min=1,max=36)  public String getClientSecret() {
    return clientSecret;
  }
 ...
 @Min(0)  public Integer getClientSecretExpiresAt() {
    return clientSecretExpiresAt;
  }
  ...
  **/
  ...
  @NotNull
 @Size(min=1)  public List<GrantTypesEnum> getGrantTypes() {
    return grantTypes;
  }
  ...
  **/
  @JsonProperty("scope")
  @NotNull
 @Size(min=1,max=256)  public String getScope() {
    return scope;
  }
 ...
 @Pattern(regexp="^[0-9a-zA-Z]{1,22}$") @Size(min=1,max=22)  public String getSoftwareId() {
    return softwareId;
  }
 ...
 @Size(min=1,max=128)  public String getTlsClientAuthSubjectDn() {
    return tlsClientAuthSubjectDn;
  }
  ...
  **/
  @JsonProperty("aud")
  @NotNull
 @Pattern(regexp="^[0-9a-zA-Z]{1,18}$") @Size(min=1,max=18)  public String getAud() {
    return aud;
  }
  ...
  **/
  @JsonProperty("iss")
  @NotNull
 @Pattern(regexp="^[0-9a-zA-Z]{1,22}$") @Size(min=1,max=22)  public String getIss() {
    return iss;
  }
  ...
  **/
  @JsonProperty("jti")
  @NotNull
 @Pattern(regexp="^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$") @Size(min=36,max=36)  public String getJti() {
    return jti;
  }
