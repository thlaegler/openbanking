...
@XmlEnumValue("Mobile") MOBILE(String.valueOf("Mobile")), @XmlEnumValue("Physical") PHYSICAL(String.valueOf("Physical"));
  ...
  **/
  ...
  @NotNull
 @Size(min=1)  public List<CustomerSegmentEnum> getCustomerSegment() {
    return customerSegment;
  }
  ...
  **/
  @JsonProperty("Note")
 @Size(min=1,max=2000)  public String getNote() {
    return note;
  }
  ...
  **/
  ...
  @NotNull
 @Size(min=1,max=35)  public String getSequenceNumber() {
    return sequenceNumber;
  }
