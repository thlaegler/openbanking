...
public class BalancesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", BalancesApi.class, providers);
     ...
     */
    @Test
    public void getAccountsAccountIdBalancesTest() {
        String accountId = null;
        String authorization = null;
        String xFapiAuthDate = null;
        String xFapiCustomerIpAddress = null;
        String xFapiInteractionId = null;
        //OBReadBalance1 response = api.getAccountsAccountIdBalances(accountId, authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId);
    ...
    public void getBalancesTest() {
        ...
        String xFapiCustomerIpAddress = null;
        String xFapiInteractionId = null;
        //OBReadBalance1 response = api.getBalances(authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId);
        //assertNotNull(response);
        // TODO: test validations
