 ...
 *
 * API tests for SmeApi 
 */
public class SmeApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", SmeApi.class, providers);
     ...
     */
    @Test
    public void unsecuredSmeLoansGetTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //UnsecuredSMELendingResponse response = api.unsecuredSmeLoansGet(ifModifiedSince, ifNoneMatch);
     ...
     */
    @Test
    public void unsecuredSmeLoansHeadTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //Object response = api.unsecuredSmeLoansHead(ifModifiedSince, ifNoneMatch);
        //assertNotNull(response);
        // TODO: test validations
