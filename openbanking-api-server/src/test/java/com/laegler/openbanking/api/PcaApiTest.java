 ...
 *
 * API tests for PcaApi 
 */
public class PcaApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost:8080/open-banking/v2.3", PcaApi.class, providers);
     ...
     */
    @Test
    public void personalCurrentAccountsGetTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //PersonalCurrentAccountResponse response = api.personalCurrentAccountsGet(ifModifiedSince, ifNoneMatch);
     ...
     */
    @Test
    public void personalCurrentAccountsHeadTest() {
        String ifModifiedSince = null;
        String ifNoneMatch = null;
        //Object response = api.personalCurrentAccountsHead(ifModifiedSince, ifNoneMatch);
        //assertNotNull(response);
        // TODO: test validations
